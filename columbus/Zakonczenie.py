...
class Zakonczenie(object):
    def __init__(self):
        ...
        printing(['''
        Po zerwaniu kwiatu paproci osiadłeś/osiadłaś w wielkim pałacu,
        ...
        kilkadziesiąt służących, a o czym pomyślisz, to staje się prawdą.
            '''])
        printing(['''
        Jesteś jednak bardzo samotny/samotna,
        nie mogłeś/mogłaś podzielić się niczym ze swoimi przyjaciółmi
        ...
        if wybor_konca == 1:
            printing(['''
        Zdecydowałeś/zdecydowałaś się pomóc biednej dziewczynce.
        W mgnieniu oka Twój imponujący pałac górujący nad wsią
        znika, znikają twoje bogato obszyte ubrania i znajdujesz się sam/a
        na środku obcej wsi. Postanawiasz wrócić do swojej rodzinnej
        wsi. Boisz się, ale jednocześnie jest Ci jakoś lżej na sercu.
                '''])
        else:
                    printing(['''
        Zdecydowałeś/zdecydowałaś się odejść. Wracasz do swojego pałacu,
